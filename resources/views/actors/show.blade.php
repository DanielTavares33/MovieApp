  ...
  <div class="movie-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
      <div class="flex-none">
        ...
        <ul class="flex items-center justify-content mt-4">
          ...
          <li class="@if($social['facebook_id']) ml-6 @endif">
      ...
      <div class="md:ml-24">
        ...
        <div class="grid grid-cols-1 justify-items-center sm:grid-cols-2 lg:grid-cols-5 gap-8">
