...
@section('content')
  <div class="movie-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
      <div class="flex-none">
        <img src="{{ 'https://image.tmdb.org/t/p/w500/' . $actor['profile_path'] }}" alt="actor image" class="w-64 md:w-96">  
      ...
      <div class="md:ml-24">
        ...
        <div class="gir grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          <div class="mt-4">
            <a href="#"><img src="https://ui-avatars.com/api/?size=470" alt="poster" class="hover:opacity-75 transition ease-in-out duration-150"></a>
  ...
  <div class="credits border-b border-gray-800"> {{-- start credits --}}
